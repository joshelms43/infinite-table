...
html = html
  .replace('<script src="../shared/config.js?v=052"></script>', '<scr'+'ipt>window.SUPABASE_URL="";window.SUPABASE_ANON="";</scr'+'ipt>')
  .replace('<script src="../shared/identity.js?v=052"></script>', '<scr'+'ipt>'+_shared('identity.js')+'</scr'+'ipt>');
